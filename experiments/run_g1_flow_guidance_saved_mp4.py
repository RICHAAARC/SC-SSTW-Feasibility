...
def main():
    ...
    try: result=run_g1_once(ROOT,args.output)
    except Exception as exc:
        print(json.dumps({"status":"INSTRUMENTATION_INSUFFICIENT","diagnostic_class":"DIAGNOSTIC_ONLY","reason":type(exc).__name__,"message":str(exc),"formal_result":False},sort_keys=True,separators=(",",":"))); return 2
