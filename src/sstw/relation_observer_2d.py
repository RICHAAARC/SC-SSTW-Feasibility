"""Frozen, non-learning saved-MP4 2D observer boundary for SSTW-v2."""
...
def observe_saved_mp4(video_path: str, decoder: Callable[[str], Sequence[object]], relation_readout: Callable[[object], Vector2]) -> tuple[Vector2, ...]:
    ...
    The decoder/readout must implement the same opponent-chroma/cosine formula
    as ``flow_guidance_embedder.fixed_observer_torch``.  This boundary offers no
    training, OFF input, key input, or adaptive fitting hook.
    """
